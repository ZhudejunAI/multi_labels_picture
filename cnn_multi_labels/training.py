...
IMG_H = 208
BATCH_SIZE = 32  # 一般是2^n
MAX_STEP = 100000  # 当前参数下，建议训练步数最好>10000
learning_rate = 0.00005  # 当前参数下，建议学习率<0.0001
...
# def get_one_image():
#     image = Image.open('images/621.jpg')
